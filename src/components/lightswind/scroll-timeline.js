...
export const ScrollTimeline = ({ events = DEFAULT_EVENTS, title = "Timeline", subtitle = "Scroll to explore the journey", animationOrder = "sequential", cardAlignment = "alternating", lineColor = "bg-primary/30", activeColor = "none", progressIndicator = true, cardVariant = "filled", cardEffect = "none", parallaxIntensity = 0.2, progressLineWidth = 2, progressLineCap = "round", dateFormat = "badge", revealAnimation = "fade", className = "", connectorStyle = "line", perspective = false, darkMode = false, smoothScroll = true, }) => {
    ...
    const getCardClasses = (index) => {
        const baseClasses = "relative -z-0 rounded-lg transition-all duration-300 w-90 sm:w-[calc(100%-40px)] lg:w-[calc(50%-40px)]";
        ...
        const effectClasses = {
            ...
            const perspectiveClass = perspective
                ...
                : "";
            return cn(baseClasses, variantClasses[cardVariant], effectClasses[cardEffect], alignmentClassesDesktop, "bg-[#000] lg:w-[calc(50%-40px)]");
        };
                  ...
                  `,
                    ...
                    `,
                                ...
                                return (_jsxs("div", { ref: (el) => {
                                    ...
                                    }, className: cn("relative flex items-center mb-2 sm:mb-10 py-4", "flex-col lg:flex-row", cardAlignment === "alternating"
                                        ? index % 2 === 0
                                            ? "lg:justify-start"
                                            : "lg:flex-row-reverse lg:justify-start"
                                        : cardAlignment === "left"
                                            ? "lg:justify-start"
                                            : "lg:flex-row-reverse lg:justify-start"), children: [_jsx("div", { className: cn("absolute top-1/2 transform -translate-y-1/2 z-30", "left-1/2 -translate-x-1/2"), children: _jsx(motion.div, { className: cn("sm:w-6 sm:h-6 sm:rounded-full sm:border-4 sm:bg-background sm:flex items-center justify-center", index <= activeIndex
                                                    ? "border-primary"
