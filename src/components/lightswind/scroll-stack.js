...
const ScrollStack = ({ cards, backgroundColor = "bg-[#000]", // Changed default to "bg-background"
cardHeight = "60vh", animationDuration = "0.5s", sectionHeightMultiplier = 3, intersectionThreshold = 0.1, className = "", }) => {
    ...
    return (_jsx("section", { ref: scrollableSectionRef, className: "relative max-h-screen w-full lg:w-[100%] overflow-y-scroll \r\n      scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-gray-300", children: _jsx("div", { ref: sectionRef, className: `relative ${className}`, style: { height: `${sectionHeightMultiplier * 100}vh` }, children: _jsx("div", { className: `sticky top-0 w-full h-screen flex items-center 
