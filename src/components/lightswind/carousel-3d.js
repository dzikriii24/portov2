            ...
            children: _jsxs("div", {
                ...
                children: [_jsx("div", {
                    ...
                    children: items.map((item, index) => (_jsx("div", {
                        ...
                        children: _jsxs(Card, {
                            className: `overflow-hidden bg-black h-[${cardHeight}px] border shadow-sm 
                hover:shadow-md flex flex-col`,
                            children: [_jsxs("div", {
                                ...
                                children: [_jsx("h3", {
                                    ...
                                    children: [_jsx("div", {
                                        ...
                                        children: item.tags.map((tag, idx) => (_jsx("span", {
                                        ...
                                        children: [_jsx("span", {
                                            ...
                                            className: "absolute left-0 bottom-0 w-0 h-0.5 bg-gray-500 transition-all duration-300 group-hover:w-full"
                                        })]
                                    })]
                                })]
                            })]
                    ...
                    children: items.map((_, idx) => (_jsx("button", {
