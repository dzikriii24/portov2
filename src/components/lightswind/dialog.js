...
import {
    motion,
    AnimatePresence
} from "framer-motion"; // Import motion, AnimatePresence, and HTMLMotionProps
...
const DialogContent = React.forwardRef( // Use the new type here
    ({
        ...
        return (_jsx(AnimatePresence, {
            children: open && ( // Conditionally render the motion components based on `open` state
                _jsxs("div", {
                    ...
                    children: [_jsx(motion.div, {
                        ...
                        "aria-modal": "true",
                        ...props,
                        children: [children, _jsxs("button", {
                            onClick: () => setOpen(false),
